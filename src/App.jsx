...
export default function App() {
  ...
  // LIVE IMPLEMENTATION: This automatically watches for a new image.
  // The moment it detects one, it fires the AI process instantly.
  useEffect(() => {
  ...
  const processImage = async (imageUrl) => {
    ...
    try {
      // The explicit CDN path ensures Vercel never loses the AI assets
      const config = {
        ...
        progress: (key, current, total) => {
          ...
          if (percent < 30) setStatusText('Downloading AI engine (First time only)...');
      ...
      alert("Processing failed. Please ensure you have a stable internet connection so the AI model can load.");
    } finally {
                ...
                <div className="bg-[#F8F9FA] rounded-[16px] border border-[#E3E3E3] p-4 aspect-square flex items-center justify-center relative overflow-hidden shadow-inner">
                  ...
                  {isProcessing ? (
                    ...
                    <div className="text-[#444746] flex flex-col items-center">
                      ...
                      <p className="text-sm font-medium">Preparing AI Engine...</p>
                    </div>
                  )}
                </div>
              </div>
